...
public class BookName {
	...
	public static ArrayList<DanhMucSach> TimTenSach(String add, String filename) {
		...
		try {
			...
			DanhMucSach search = new DanhMucSach(null, bookName, null, null, null);
			if (dataBook.contains(search)) {
				...
				System.out.println("Khong tim thay sach nay");
			}
		} catch (Exception e) {
